...
class DomainParameters(ABC):
    """ Wrapper for domain parameters. """
    @abstractmethod
    def generate_public_key(self,d):
        pass


class M_221(EllipticCurve, DomainParameters):
...
class Curve25519(EllipticCurve, DomainParameters):
    ...
    def __init__(self):
        ...
        self.G = ECPoint(9,          14781619447589544791020593568409986887264606134616475288964881837755586237401
        )
...
class DiffieHellmanProtocolParty:
    """ Implements a party in the Diffie-Hellman Protocol.
    """ 
    def __init__(self, 
